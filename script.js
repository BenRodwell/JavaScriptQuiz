...
var quizQuestions = [{
    ...
    correctAnswer: "b"},
  {
    ...
    correctAnswer: "d"},
   {
    ...
    choiceA: "let myVar = 10",
    choiceB: "var myVar = 10",
    choiceC: "const myVar = 10",
    ...
    choiceA: "To set the text of an element",
    choiceB: "To execute a function after a specified delay",
    choiceC: "To change the color of an element",
    choiceD: "To create a new object",
    correctAnswer: "b"},
